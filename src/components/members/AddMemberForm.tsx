...
import { User, Dumbbell, CreditCard, CheckCircle2, ArrowRight, ArrowLeft, Loader2, Upload } from "lucide-react"
...
const MOCK_PLANS = [
  { id: "1", name: "1-Month Basic", price: 1500, duration: 30 },
  { id: "2", name: "3-Month Premium", price: 4000, duration: 90 },
  { id: "3", name: "Annual Pass", price: 12000, duration: 365 },
]

// 1. Zod Validation Schema (FIXED TS ERROR HERE)
const memberSchema = z.object({
  ...
  sendWelcomeMsg: z.boolean(), // Removed .default(true) to fix RHF type mismatch
})
...
export function AddMemberForm() {
 ...
 // Next Step with Validation
  const handleNext = async () => {
    // Explicitly define the array as keys of our FormValues instead of 'any'
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    // TODO: Supabase Insert Logic goes here
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className={cn("space-y-6 animate-in fade-in slide-in-from-right-4 duration-500", step !== 1 && "hidden")}>
            ...
            <div className="flex items-center justify-center w-full sm:w-32 h-32 rounded-2xl bg-dark-900 border border-dark-700 border-dashed text-dark-400 hover:text-gold-500 hover:border-gold-500/50 transition-colors cursor-pointer mb-6 mx-auto sm:mx-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField control={form.control} name="dob" render={({ field }) => (
                <FormItem><FormLabel className="text-dark-200">Date of Birth</FormLabel>
                  {/* FIXED TAILWIND: [color-scheme:dark] -> scheme-dark */}
              ...
              <div className="md:col-span-2">
                <FormField control={form.control} name="healthNotes" render={({ field }) => (
                  <FormItem><FormLabel className="text-dark-200">Health Notes / Injuries</FormLabel>
                    <FormControl>
                      {/* FIXED TAILWIND: min-h-[100px] -> min-h-25 */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField control={form.control} name="amount" render={({ field }) => (
                <FormItem><FormLabel className="text-dark-200">Amount Received (₹)</FormLabel>
                  {/* FIXED TAILWIND CSS CONFLICT: Removed 'text-white' so 'text-gold-500' applies properly */}
          ...
          <div className="flex items-center justify-between pt-8 border-t border-dark-800">
            ...
            {step < 3 ? (
              ...
              <Button 
                ...
                /* FIXED TAILWIND: bg-gradient-to-r -> bg-linear-to-r */
