  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-dark-800 border border-dark-600 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-dark-300 text-sm font-medium">Active Members</h3>
            <div className="p-2 bg-green-500/10 rounded-lg"><Users className="w-4 h-4 text-green-500" /></div>
          </div>
          <p className="text-3xl font-bold text-white">{data.summary.total_active}</p>
        </div>

        <div className="bg-dark-800 border border-dark-600 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-dark-300 text-sm font-medium">Active PT Clients</h3>
            <div className="p-2 bg-gold-500/10 rounded-lg"><Dumbbell className="w-4 h-4 text-gold-500" /></div>
          </div>
          <p className="text-3xl font-bold text-white">{data.summary.active_pt}</p>
        </div>

        <div className="bg-dark-800 border border-dark-600 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-dark-300 text-sm font-medium">Expiring Soon (7 Days)</h3>
            <div className="p-2 bg-yellow-500/10 rounded-lg"><AlertCircle className="w-4 h-4 text-yellow-500" /></div>
          </div>
          <p className="text-3xl font-bold text-white">{data.summary.total_expiring}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Revenue Bar Chart */}
        <div className="lg:col-span-2 bg-dark-800 border border-dark-600 rounded-xl p-6 shadow-sm">
          <h3 className="text-lg font-bold text-white mb-6">Revenue Trend (Last 7 Months)</h3>
          <div className="h-72">
        ...
        <div className="bg-dark-800 border border-dark-600 rounded-xl p-6 shadow-sm flex flex-col">
          <h3 className="text-lg font-bold text-white mb-2">Member Status Distribution</h3>
          ...
          {/* Custom Legend */}
          <div className="flex justify-center gap-4 mt-4 text-sm text-dark-300">
